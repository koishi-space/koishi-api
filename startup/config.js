...
module.exports = function () {
  ...
  if (!config.get("telegram_token")) console.log("[SERVER] KOISHI_TELEGRAM_TOKEN is not set - Telegram bot will not be used");

  if (!config.get("telegram_chat_id")) console.log("[SERVER] KOISHI_TELEGRAM_CHAT_ID is not set - Telegram bot will not be used");
};
